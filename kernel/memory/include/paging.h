...
void allocate_region(page_directory_t *dir, uint32_t start_va, uint32_t end_va,
...
void free_region(page_directory_t *dir, uint32_t start_va, uint32_t end_va,
		 int free);
...
page_table_t *copy_page_table(page_directory_t *src_page_dir,
			      page_directory_t *dst_page_dir,
			      uint32_t page_dir_idx, page_table_t *src);
