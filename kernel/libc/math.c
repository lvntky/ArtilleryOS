...
double sin(double x)
{
	...
	return x - exp(x, 3) / 6.0 + exp(x, 5) / 120.0 - exp(x, 7) / 5040.0;
}
...
double cos(double x)
{
	...
	return 1.0 - exp(x, 2) / 2.0 + exp(x, 4) / 24.0 - exp(x, 6) / 720.0;
}
...
{
	return x + ((exp(x, 3)) / 6) + ((1 * 3 * exp(x, 5)) / 40.0) +
	       ((1 * 3 * 5 * exp(x, 7)) / 384.0);
}
...
{
	return (PI / 2) - x - (exp(x, 3) / 6.0) - (3 * exp(x, 5)) / 40.0 +
	       (15 * exp(x, 7)) / 336.0;
}
...
{
	return x - exp(x, 3) / 3.0 + exp(x, 5) / 5.0 - exp(x, 7) / 7.0 +
	       exp(x, 9) / 9.0 - exp(x, 11) / 11.0 + exp(x, 13) / 13.0 -
	       exp(x, 15) / 15.0 + exp(x, 17) / 17.0;
}
